    ...
    <div class="flex h-16 items-center justify-between">
      <div class="flex items-center">
        <div class="flex-shrink-0">
          <p class="text-white text-3xl"><i class="fa-solid fa-person-hiking"></i></p>
        </div>
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/subscribe" class="<?= urlIs('/subscribe') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Subscribe</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
