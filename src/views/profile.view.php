    ...
    <div class="mx-auto max-w-2xl py-16 sm:py-24 lg:max-w-none lg:py-16">
        ...
        <div>
          <div class="flex -space-x-2 overflow-hidden">
            <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" src="<?= $_SESSION['users']['profil_picture']?>" class="inline-block h-50 w-50 rounded-full ring-2 ring-white" alt="">
          </div>
          <h3 class="mt-6 text-sm text-gray-500">
              <p class="text-base font-semibold text-gray-900"><?= $_SESSION['users']['firstname'] . " " . $_SESSION['users']['lastname']?>Firstname Lastname</p>
